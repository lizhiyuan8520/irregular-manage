  ...
  <div class="container">
    ...
    <div class="listArea">
      ...
      >
        ...
        <el-table-column prop="bffzxs" label="泵房布置形式" />
        <el-table-column prop="bfjgxs" label="泵房结构形式" />
        <el-table-column prop="bqzzxl" label="泵站装置效率" />
        <el-table-column prop="buildDate" label="修建时间" />
        <el-table-column prop="csdsw" label="出水池最低水位" />
        <el-table-column prop="csgsw" label="出水池最高水位" />
        <el-table-column prop="djgl" label="动力机功率备用系数" />
        <el-table-column prop="djlx" label="动力机类型" />
        <el-table-column prop="jddxzq" label="机电设备维护周期" />
        <el-table-column prop="jdgxyear" label="机电设备更新年限" />
        <el-table-column prop="jdstate" label="机电设备完好状况" />
        <el-table-column prop="jzsl" label="机组数量" />
        <el-table-column prop="kind" label="引水方式" />
        <el-table-column prop="level" label="工程等级和规模" />
        <el-table-column prop="lift" label="扬程" />
        <el-table-column prop="maxtsll" label="最大提水流量" />
        <el-table-column prop="mintsll" label="最小提水流量" />
        <el-table-column prop="maxyc" label="最高扬程" />
        <el-table-column prop="minyc" label="最低扬程" />
        <el-table-column prop="pjyc" label="平均扬程" />
        <el-table-column prop="power" label="功率" />
        <el-table-column prop="qcdsw" label="泵站前池最低水位" />
        <el-table-column prop="qcgsw" label="泵站前池最高水位" />
        <el-table-column prop="roomStructure" label="泵房结构图" />
        <el-table-column prop="sjll" label="设计流量" />
        <el-table-column prop="sjyc" label="设计扬程" />
        <el-table-column prop="splx" label="水泵类型" />
        <el-table-column prop="zjgl" label="装机功率" />
        <el-table-column prop="zjxl" label="装机效率" />
...
import { saveBz, getBzDetailById, delBz, getBzList } from "@/api/bz"; // 根据实际路径修改
...
const openDialog = (row) => {
  ...
  if (row.id) {
    getBzDetailById(row.id).then((res) => {
