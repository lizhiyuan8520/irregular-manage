  ...
  <div class="container">
    ...
    <div class="listArea">
      ...
      >
        ...
        <el-table-column prop="speed" label="流量(m³/s)" />
        <el-table-column prop="state" label="设备状态">
          <template #default="scope">
            {{ scope.row.state == 0 ? "异常" : "正常" }}
          </template>
        </el-table-column>
        <el-table-column prop="material" label="图标">
          <template #default="scope">
            <el-image
        ...
        <el-table-column label="操作" width="180">
          <template #default="scope">
            ...
            >
            <el-popconfirm
              title="删除点位分组将会导致分组下的点位都不可用,确定删除吗?"
    ...
    >
      ...
      >
        ...
        >
          <el-input v-model="pointGroupForm.name" placeholder="请输入名称" />
        </el-form-item>
        ...
        <el-form-item label="点位图标" prop="snapshot">
          ...
          >
            <img
              v-if="pointGroupForm.snapshot"
              :src="pointGroupForm.snapshot"
              class="avatar"
            />
...
import { editLcs, getLcsDetailById, delLcs, getLcsList } from "@/api/lcs"; // 根据实际路径修改
